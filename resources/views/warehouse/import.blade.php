                ...
                <div class="row g-3">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="mt-3 small">
                            <div class="fw-semibold mb-1">Два формата текста:</div>
                            <ul class="mb-2 ps-3">
                                <li><b>Строчный:</b> «NIKE DUNK LOW - 41,42.5,43» (кол-во каждой пары — из поля слева).</li>
                                <li><b>Блочный</b> (блоки через пустую строку):<br>
                                    <code>New balance 9060</code><br>
                                    <code>42,43(2)</code> ← в скобках кол-во пар, без скобок = 1<br>
                                    <code>U9060ORA</code> ← артикул (расцветка)</li>
                                <li>Склейки без запятой понимаются: «38(2)37.5».</li>
                                <li>Первое слово — <b>бренд</b>; NEW BALANCE — двусоставный; «W Nike …» тоже ок.</li>
                            </ul>
