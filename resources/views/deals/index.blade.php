...
<div class="d-flex align-items-center justify-content-between mb-3">
  ...
  <form class="d-flex" method="GET" action="{{ route('deals.index') }}">
    <input class="form-control form-control-sm me-2" name="q" value="{{ $q }}" placeholder="поиск: имя, телефон, заголовок">
